...
cran_packages <- c(
  ...
  "ComplexHeatmap","VennDiagram" # Added ggVennDiagram
...
# plot(five_way_venn, type="upset", mycol=custom_colors, intersect.line.color="gray30")
# plot(five_way_venn, type="upset", mycol=custom_colors, intersect.line.color="red")
# plot(five_way_venn, type="upset", mycol=custom_colors, 
